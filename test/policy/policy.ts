contract('Policy', () => {
	...
	describe('PolicyTest; holdersShare', () => {
	...
	describe('PolicyTest; assetValue', () => {
	...
	describe('PolicyTest; authenticationFee', () => {
	...
	describe('PolicyTest; marketApproval', () => {
	...
	describe('PolicyTest; policyApproval', () => {
	...
	describe('PolicyTest; marketVotingBlocks', () => {
	...
	describe('PolicyTest; policyVotingBlocks', () => {
	...
	describe('PolicyTest; abstentionPenalty', () => {
	...
	describe('PolicyTest; lockUpBlocks', () => {
