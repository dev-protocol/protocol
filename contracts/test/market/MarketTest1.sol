...
contract MarketTest1 is IMarketBehavior, UsingConfig {
	...
	event LogCalculate(address _metrics, uint256 _lastBlock, uint256 _currentBlock);
	...
	function calculate(address _metrics, uint256 _lastBlock, uint256 _currentBlock)
		external
		returns (bool)
	{
